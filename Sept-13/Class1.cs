...
namespace ClassLibrary1
{
    ...
    public class User : Movie
    {
        ...
        {
            Movie m = new Movie("Aruvi", "Tamil", "Psychology", 50);
            dbmovies.Add(m);
            Movie k = new Movie("Rakshasan", "Tamil", "Thriller", 30);
            dbmovies.Add(k);
            Movie t = new Movie("June", "Malayalam", "Romance", 30);
            dbmovies.Add(t);
            Movie n = new Movie("PK", "Hindi", "Romance", 30);
            dbmovies.Add(n);
        ...
        public List<Movie> adding(List<Movie> rented1, string Type1)
        {
            ...
            else
            {
                ...
                {
                    Console.WriteLine("The requested one is not available");
                    return rented1;
                }
