...
namespace sept14_handson
{
    ...
    public class Searching
    {
        ...
        {
            movies.Add(new Movie("Aruvi", "Tamil", "Psychology", 50));
            movies.Add(new Movie("PK", "Hindi", "SitCom", 40));
            movies.Add(new Movie("Rakshasan", "Tamil", "Thriller", 50));
            movies.Add(new Movie("de-Monde Colony ", "Tamil", "Thriller", 60));
            movies.Add(new Movie("June", "Malayalam", "Romance", 45));
        }
        public void search()
        {
    ...
    public class CustomerUser : Searching
    {
        ...
        {
            if (Id == 6379475752 && Password == "hello123")
            {
                login = "true";
                return true;
            }
